...
const teamDetails = {
  pramod: {
    name: "Sarthak Nayak",
    role: "Product Head",
    exp: "5+ years of IT experience",
    qualification: "BTech(Infomation Technology)",
    achievements: "Worked as team lead in a fintech company",
    photo: "assets/images/sarthak.jpg",
    audio: "assets/audio/pramod-intro.mp3"
  },
  anannya: {
    name: "Ananya Kumar Mishra",
    role: "Senior Faculty - Science & Mathematics",
    exp: "7+ years of teaching experience",
    qualification: "B.Sc(Science),M.A(Sociology),M.A(Political Science)",
    achievements: "National level debator and a writer",
